...
int CClassView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	//CEntityManager::getInstance()->setClassView(this);
  //GetEntityMgr()->eventEntityCreated += FastDelegate1<IEntity*>(this, &CClassView::AddInstanceItems);
  //GetEntityMgr()->eventEntityRemoved += FastDelegate1<IEntity*>(this, &CClassView::RemoveInstanceItems);
...
{
	HTREEITEM hRoot = m_wndClassView.InsertItem(_T("Spawned entities"), 0, 0);
