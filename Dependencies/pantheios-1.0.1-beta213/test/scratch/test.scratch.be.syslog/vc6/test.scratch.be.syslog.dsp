# Microsoft Developer Studio Project File - Name="test.scratch.be.syslog" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=test.scratch.be.syslog - Win32 Debug Multithreaded DLL pseudoUNIX
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "test.scratch.be.syslog.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "test.scratch.be.syslog.mak" CFG="test.scratch.be.syslog - Win32 Debug Multithreaded DLL pseudoUNIX"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "test.scratch.be.syslog - Win32 Release pseudoUNIX" (based on "Win32 (x86) Application")
!MESSAGE "test.scratch.be.syslog - Win32 Debug pseudoUNIX" (based on "Win32 (x86) Application")
!MESSAGE "test.scratch.be.syslog - Win32 Release Multithreaded pseudoUNIX" (based on "Win32 (x86) Application")
!MESSAGE "test.scratch.be.syslog - Win32 Debug Multithreaded pseudoUNIX" (based on "Win32 (x86) Application")
!MESSAGE "test.scratch.be.syslog - Win32 Release Multithreaded DLL pseudoUNIX" (based on "Win32 (x86) Application")
!MESSAGE "test.scratch.be.syslog - Win32 Debug Multithreaded DLL pseudoUNIX" (based on "Win32 (x86) Application")
!MESSAGE 
...
!IF  "$(CFG)" == "test.scratch.be.syslog - Win32 Release pseudoUNIX"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib advapi32.lib ole32.lib oleaut32.lib /nologo /subsystem:console /machine:I386 /out:"../../../../bin/test.scratch.be.syslog.vc6.unix.exe" /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(UNIXEM)/lib" /libpath:"$(SYNESIS_DEV)/lib"
# ADD LINK32 libWinSysLog.vc6.lib pthreadVC.lib kernel32.lib advapi32.lib ole32.lib oleaut32.lib ws2_32.lib /nologo /subsystem:console /machine:I386 /out:"../../../../bin/test.scratch.be.syslog.vc6.unix.exe" /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(UNIXEM)/lib" /libpath:"$(SYNESIS_DEV)/lib" /libpath:"$(PTHREADS_WIN32)/lib"

!ELSEIF  "$(CFG)" == "test.scratch.be.syslog - Win32 Debug pseudoUNIX"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib advapi32.lib ole32.lib oleaut32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../../../bin/test.scratch.be.syslog.vc6.unix.debug.exe" /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(UNIXEM)/lib" /libpath:"$(SYNESIS_DEV)/lib"
# ADD LINK32 pthreadVC.lib kernel32.lib advapi32.lib ole32.lib oleaut32.lib ws2_32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../../../bin/test.scratch.be.syslog.vc6.unix.debug.exe" /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(UNIXEM)/lib" /libpath:"$(SYNESIS_DEV)/lib" /libpath:"$(PTHREADS_WIN32)/lib"

!ELSEIF  "$(CFG)" == "test.scratch.be.syslog - Win32 Release Multithreaded pseudoUNIX"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib advapi32.lib ole32.lib oleaut32.lib /nologo /subsystem:console /machine:I386 /out:"../../../../bin/test.scratch.be.syslog.vc6.unix.mt.exe" /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(UNIXEM)/lib" /libpath:"$(SYNESIS_DEV)/lib"
# ADD LINK32 libWinSysLog.vc6.mt.lib pthreadVC.lib kernel32.lib advapi32.lib ole32.lib oleaut32.lib ws2_32.lib /nologo /subsystem:console /machine:I386 /out:"../../../../bin/test.scratch.be.syslog.vc6.unix.mt.exe" /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(UNIXEM)/lib" /libpath:"$(SYNESIS_DEV)/lib" /libpath:"$(PTHREADS_WIN32)/lib"

!ELSEIF  "$(CFG)" == "test.scratch.be.syslog - Win32 Debug Multithreaded pseudoUNIX"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib advapi32.lib ole32.lib oleaut32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../../../bin/test.scratch.be.syslog.vc6.unix.mt.debug.exe" /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(UNIXEM)/lib" /libpath:"$(SYNESIS_DEV)/lib"
# ADD LINK32 libWinSysLog.vc6.mt.debug.lib pthreadVC.lib kernel32.lib advapi32.lib ole32.lib oleaut32.lib ws2_32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../../../bin/test.scratch.be.syslog.vc6.unix.mt.debug.exe" /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(UNIXEM)/lib" /libpath:"$(SYNESIS_DEV)/lib" /libpath:"$(PTHREADS_WIN32)/lib"

!ELSEIF  "$(CFG)" == "test.scratch.be.syslog - Win32 Release Multithreaded DLL pseudoUNIX"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib advapi32.lib ole32.lib oleaut32.lib /nologo /subsystem:console /machine:I386 /out:"../../../../bin/test.scratch.be.syslog.vc6.unix.dll.exe" /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(UNIXEM)/lib" /libpath:"$(SYNESIS_DEV)/lib"
# ADD LINK32 libWinSysLog.vc6.dll.lib pthreadVC.lib kernel32.lib advapi32.lib ole32.lib oleaut32.lib ws2_32.lib /nologo /subsystem:console /machine:I386 /out:"../../../../bin/test.scratch.be.syslog.vc6.unix.dll.exe" /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(UNIXEM)/lib" /libpath:"$(SYNESIS_DEV)/lib" /libpath:"$(PTHREADS_WIN32)/lib"

!ELSEIF  "$(CFG)" == "test.scratch.be.syslog - Win32 Debug Multithreaded DLL pseudoUNIX"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib advapi32.lib ole32.lib oleaut32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../../../bin/test.scratch.be.syslog.vc6.unix.dll.debug.exe" /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(UNIXEM)/lib" /libpath:"$(SYNESIS_DEV)/lib"
# ADD LINK32 libWinSysLog.vc6.dll.debug.lib pthreadVC.lib kernel32.lib advapi32.lib ole32.lib oleaut32.lib ws2_32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../../../bin/test.scratch.be.syslog.vc6.unix.dll.debug.exe" /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(UNIXEM)/lib" /libpath:"$(SYNESIS_DEV)/lib" /libpath:"$(PTHREADS_WIN32)/lib"

!ENDIF 

# Begin Target

# Name "test.scratch.be.syslog - Win32 Release pseudoUNIX"
# Name "test.scratch.be.syslog - Win32 Debug pseudoUNIX"
# Name "test.scratch.be.syslog - Win32 Release Multithreaded pseudoUNIX"
# Name "test.scratch.be.syslog - Win32 Debug Multithreaded pseudoUNIX"
# Name "test.scratch.be.syslog - Win32 Release Multithreaded DLL pseudoUNIX"
# Name "test.scratch.be.syslog - Win32 Debug Multithreaded DLL pseudoUNIX"
...
SOURCE=..\test.scratch.be.syslog.cpp
# End Source File
# End Group
